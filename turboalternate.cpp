...
int main()
{
	...
	LARGE_INTEGER rightStart;       // point at which the right skip-walk function key began being held
	...
	int rightHeldFrames;            // length of time the right skip-walk function key was held for
	...
	int alternateStartFrames;       // alternateStart in WA frame lengths
	LARGE_INTEGER alternateTick;    // for comparison between timer query points
	int alternateTickFrames;        // alternateTick in WA frame lengths
	int alternateHeldFrames;        // length of time the arrow-key-alternating function key was held for
